...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="/ncs/img/logo3.png" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
        ...
        <nav id="gnb">
            ...
            $gnb_zindex = 999; // gnb_1dli z-index 값 설정용
                    ...
                    <li class="gnb_1dli <?php echo $add_class; ?>" style="z-index:<?php echo $gnb_zindex--; ?>">
                        <a href="<?php echo $row['me_link']; ?>" target="_<?php echo $row['me_target']; ?>" class="gnb_1da" style="color:white;" font-size:"1.5rem"><?php echo $row['me_name'] ?></a>
                        <?php
                        $k = 0;
